...
api = {
    'login': 'https://pro.yuketang.cn/pc/login/verify_pwd_login/',
    'onlesson': 'https://pro.yuketang.cn/api/v3/classroom/on-lesson',
    'attendlesson': 'https://pro.yuketang.cn/v/lesson/lesson_info_v2',
    'attendlessonv3': 'https://pro.yuketang.cn/api/v3/classroom/basic-info'
}
times = 960
counts = 0
